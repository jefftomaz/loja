...
import br.com.loja.jpa.controller.ClienteJpaController;
...
public class ClienteController implements Serializable {
    ...
    private ClienteJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new ClienteJpaController(Persistence.createEntityManagerFactory("lojaPU"));
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getClienteCount();
                }
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/en_us").getString("ClienteCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/en_us").getString("ClienteUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/en_us").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/en_us").getString("ClienteDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/en_us").getString("PersistenceErrorOccured"));
        }
    }
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getClienteCount();
